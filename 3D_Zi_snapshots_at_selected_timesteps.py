            ...
            for m, run in enumerate(numRun):
                ...
                for par_file in par_files:
                    ...
                    if timestep_range is None:
                        ...
                        timesteps_to_plot = list(range(max(0, start), min(min_length, end), 50))  # Step of 50
...
def create_photorealistic_plots_all_phi(timestep_range=None, sphere_resolution=40):
    ...
    for phi_val in phi:
        ...
        process_3d_visualization(phi_val, timestep_range=timestep_range, create_animation_flag=False,
                                sphere_resolution=sphere_resolution)
...
if __name__ == "__main__":
    ...
    print("Creating VPython-style 3D spheres for all phi values with timesteps 0, 50, 100, ..., 2000...")
