...
def create_coordination_distribution_plots(results, output_directory):
    ...
    P(n) is the probability distribution of coordination numbers.
...
if __name__ == "__main__":
    ...
    output_directory = Path("/Volumes/T7 Shield/3D Analysis 10r/plot 3")  # Changed to "plot 3"
    ...
    print("\nCreating coordination number distribution plots...")
