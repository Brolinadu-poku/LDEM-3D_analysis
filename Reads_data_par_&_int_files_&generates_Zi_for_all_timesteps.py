...
if system_platform == 'Darwin':  # Check if the OS is macOS
    topDir = Path("/Volumes/T7 Shield/NEW KN VALUES FOR SUSPENSION DYNAMICS/Stress 2r")  # Set top directory path for macOS
    output_path = Path("/Volumes/T7 Shield/3D Analysis")  # Set output directory path for macOS
elif system_platform == 'Linux':  # Check if the OS is Linux
    topDir = Path("/Volumes/T7 Shield/NEW KN VALUES FOR SUSPENSION DYNAMICS/Stress 2r")  # Set top directory path for Linux
